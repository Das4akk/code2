...
// 1. Add extraction methods to MediaResolverClient
...
// 2. Add resolution logic to MediaResolverClient.resolve
...
// 3. Add VkPlayerManager and VimeoPlayerManager
...
fs.writeFileSync('app.js.tmp', code);
