    ...
    items: [
      {
        ...
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Animals%20and%20Nature/Sun.webp",
        default: false,
        onChange: (val) => {
      ...
      },
      {
        ...
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Activity/Sparkler.webp",
        default: true,
        onChange: (val) => {
      ...
      },
      {
        ...
        desc: "Видимость фона",
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Light%20Bulb.webp",
        default: 1,
        onChange: (val) => {
      ...
      },
      {
        ...
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/People/Eyes.webp",
        default: false,
        onChange: (val) => {
      ...
      },
      {
        ...
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Sponge.webp",
        default: false,
        onChange: (val) => {
      ...
      },
      {
        ...
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Animals%20and%20Nature/Full%20Moon.webp",
        default: false,
        onChange: (val) => {
    ...
    items: [
      {
        ...
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Abacus.webp",
        default: false,
        onChange: (val) => {
      ...
      },
      {
        ...
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Animals%20and%20Nature/New%20Moon.webp",
        default: false,
        onChange: (val) => {
      ...
      },
      {
        ...
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Microscope.webp",
        default: false,
        onChange: (val) => {
      ...
      },
      {
        ...
        icon: "https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Hourglass%20Not%20Done.webp",
        default: false,
        onChange: (val) => {
...
function initSettingsRenderer() {
  ...
  html += `
   <div style="margin-bottom: 20px;">
      <h3 style="font-size: 18px; margin-bottom: 15px; font-weight: 800; display: flex; align-items: center; gap: 8px;">
        <img src="https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Key.webp" style="width: 24px;"> Аккаунт и Безопасность
      </h3>
      <div class="settings-security-card" id="security-email-card" style="background: rgba(255,255,255,0.02); border-radius: 16px; border: 1px solid var(--border-light); margin-bottom: 12px; overflow: hidden; transition: all 0.3s; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
        <div style="padding: 20px; display: flex; justify-content: space-between; align-items: center; cursor: pointer;" onclick="document.getElementById('security-email-form').style.display = document.getElementById('security-email-form').style.display === 'none' ? 'block' : 'none';">
          <div style="display: flex; align-items: center; gap: 12px;">
            <div style="width: 40px; height: 40px; background: rgba(255,143,198,0.1); border-radius: 12px; display: flex; align-items: center; justify-content: center;">
              <img src="https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Incoming%20Envelope.webp" style="width: 24px;">
            </div>
            <div>
        ...
        <div id="security-email-form" style="display: none; padding: 0 20px 20px 20px; border-top: 1px solid rgba(255,255,255,0.05); margin-top: 5px; padding-top: 20px;">
          <div style="display:flex; flex-direction:column; gap:12px;">
            ...
            <button class="primary-btn" id="btn-settings-change-email" style="font-size: 14px; padding: 12px; border-radius: 10px; margin-top: 10px;">Продолжить <img src="https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/People/Rightwards%20Hand.webp" style="width:16px;height:16px;vertical-align:text-bottom;"></button>
          </div>
        </div>
      </div>
      ...
      <div class="settings-security-card" id="security-password-card" style="background: rgba(255,255,255,0.02); border-radius: 16px; border: 1px solid var(--border-light); overflow: hidden; transition: all 0.3s; box-shadow: 0 4px 20px rgba(0,0,0,0.1);">
        <div style="padding: 20px; display: flex; justify-content: space-between; align-items: center; cursor: pointer;" onclick="document.getElementById('security-password-form').style.display = document.getElementById('security-password-form').style.display === 'none' ? 'block' : 'none';">
          <div style="display: flex; align-items: center; gap: 12px;">
            <div style="width: 40px; height: 40px; background: rgba(255,143,198,0.1); border-radius: 12px; display: flex; align-items: center; justify-content: center;">
              <img src="https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Key.webp" style="width: 24px;">
            </div>
            <div>
...
class GlobalThemeManager {
  static storageKey = "cowio:globalTheme";
  ...
  static applyTheme() {
    document.documentElement.dataset.globalTheme = "dark";
    document.documentElement.classList.remove("theme-light-global");
    document.body?.classList.remove("theme-light-global");
  }
...
class ThemeManager {
  ...
  static getThemeLabel() {
    return '';
  }

  static renderCarouselTrack() {}

  static findFolderForTheme() {
    return 'classic';
  }
