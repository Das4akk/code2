class ProfileManager {
  ...
  static getRoleBadgeHtml(profile, uid = null) {
    ...
    const adminImg = `<span class="role-badge-icon-wrapper" data-tooltip="Администратор" onclick="event.stopPropagation(); if(window.Utils) Utils.showBadgeModal('Администратор', 'Управляет платформой и модераторами.', 'https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Gem%20Stone.webp')"><img src="https://cdn.jsdelivr.net/gh/Tarikul-Islam-Anik/Telegram-Animated-Emojis@main/Objects/Gem%20Stone.webp" class="role-badge-icon" style="width:1.2em;height:1.2em;vertical-align:bottom;" title=""></span>`;
