...
class HelpGuideManager {
  ...
  static TOPICS = [
    ...
    },
    {
      ...
      icon: "https://raw.githubusercontent.com/Tarikul-Islam-Anik/Telegram-Animated-Emojis/main/Objects/Open%20Book.webp",
      items: [
        { q: "Что такое библиотека?", a: "«Библиотека» — это общий каталог видео и фильмов, которые добавляют сами пользователи. Можно искать интересные ролики, смотреть, кто есть на превью (работает нейросеть), и в один клик создавать комнаты из видеокарточек." },
        { q: "Как добавить своё видео?", a: "Во вкладке «Библиотека» нажмите «+ Добавить видео». Вставьте ссылку (YouTube и др.), укажите название и подробное описание от 40 символов. Если вы сделаете его публичным, оно появится в общей библиотеке у всех." },
        { q: "Что за определение лиц?", a: "Когда вы добавляете видео для всех, наш ИИ сканирует превью и сам определяет, какие блогеры или известные личности на нём изображены. Вы также можете отредактировать список перед сохранением." },
        { q: "Что такое «Моя библиотека»?", a: "Это ваш личный раздел видео. Туда попадают ролики, которые вы сохранили с галочкой «Приватное»." }
      ],
    },
    {
      id: "rooms",
